...
The aim is to investigate whether the shift to remote working during the COVID-19 pandemic led to a detectable increase in perscriptions in musculoskeletal pain relieving drugs, specifically the use of non-steroidal anti-inflammatory drugs and musculoskeletal (MSK) drugs, in Scotland.
...
#the code above essentially runs the code but do not show the loading packages or any unwanted messages in the final PDF/HTML 
...
# Print the final, small data frame to check work if you wish to confirm the data is correct 
